...
import logging
from utils import load_products, save_receipt
...
class CashierApp:
    ...
    def add_product(self):
        ...
        self.shopping_cart[product_name] = (
            self.shopping_cart.get(product_name, 0) + quantity
        )

        self.total_price += price

        logger.info("Product added: %s (x%d)", product_name, quantity)
    ...
    def apply_discount(self):
        ...
        membership = simpledialog.askstring(
    ...
    def create_gui(self):
        ...
        self.product_entry.bind("<Return>", lambda event: self.quantity_entry.focus())
        ...
        self.final_label = tk.Label(
            self.root,
            text="Final Price will appear here",
            font=("Arial", 12, "bold")
        )
